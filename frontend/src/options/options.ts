...
class OptionsController implements IOptionsController {
    ...
    this.llmProviders = [
      {
        ...
        helpText: 'Get API key from platform.openai.com.',
      },
      {
        id: 'anthropic',
        ...
        requiresCustomEndpoint: false,
        helpText: 'Get API key from console.anthropic.com.',
      },
      {
        id: 'xai',
        name: 'xAI (Grok)',
        ...
        requiresCustomEndpoint: false,
        helpText: 'Get API key from x.ai console.',
      },
      {
        id: 'ollama',
        name: 'Ollama (Local)',
        ...
        helpText: 'Ensure Ollama server is running.',
      },
    ];
  }
  ...
  public async saveLLMConfiguration(): Promise<void> {
    ...
    if (!provider) {
      cfgToSave = { providerId: null, apiKey: null, selectedModelId: null, customEndpoint: null };
    } else {
      const apiKeyInput = document.getElementById('llm-api-key') as HTMLInputElement;
